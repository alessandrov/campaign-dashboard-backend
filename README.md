...
Make sure your local instance of MySQL is running.
The application will create a new database at every startup as well as tables mapped by the JPA entities.
You can change your MySQL credentials in the resources/application.properties file.
